...
*/
	...
	// 2nd UPC for loop
	  ...
	  if((i-wj)/interval != MYTHREAD ) {
        ...
        upc_memput( (shared void*) (&T[cap+1]+MYTHREAD*250), (void*) Tlocal, 250*sizeof(int) );
...
int main( int argc, char** argv )
{
   ...
   FILE *fsave = savename ? fopen( savename, "w" ) : NULL;
    ...
    total  = (shared [250] int *) upc_all_alloc( nitems * (capacity+1)/250, 250*sizeof(int) );
    ...
    global  = (shared [250] int *) upc_all_alloc( 5000*1000/250, nBytes ); // numBlocks, numBytes
    upc_barrier;
